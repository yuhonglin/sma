...
enum SolverExitStatus { 
  success=0,              // The algorithm has converged to a stationary
  // point or has reached the maximum number of
  // iterations.
  abnormalTermination=1,  // The algorithm has terminated abnormally and
  // was unable to satisfy the convergence
  // criteria.
  errorOnInput=2          // The routine has detected an error in the
  // input parameters.
};
